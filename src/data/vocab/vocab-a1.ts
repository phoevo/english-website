export const vocabA1: Record<string, { text: string; type: string; definition: string; context: string; }> = {
  ...
  "want": { text: "want", type: "verb", definition: "to wish to have something", context: "What sort of paint do you want?" },
  "sure": { text: "sure", type: "adjective", definition: "not certain", context: "I’m not sure really." },
  ...
  "start": { text: "start", type: "verb", definition: "to begin doing something", context: "Before you start with the undercoat." },
  "how": { text: "how", type: "adverb", definition: "used to ask about the way or amount", context: "How long does it take?" },
  "long": { text: "long", type: "adjective", definition: "lasting a large amount of time", context: "How long does it take?" },
  "take": { text: "take", type: "verb", definition: "to need time to do something", context: "How long does it take?" },
