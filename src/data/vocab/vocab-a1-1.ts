export const vocabA1_1: Record<string, { text: string; type: string; definition: string; context: string }> = {
  ...
  "summit": { text: "summit", type: "noun", definition: "highest point of a mountain" },
  ...
  "afternoon": { text: "afternoon", type: "noun", definition: "time after noon/12:00" },
  ...
  "waterfall": { text: "waterfall", type: "noun", definition: "a place in a river where water spills suddenly downward" },
  ...
  "info": { text: "info", type: "noun", definition: "short for: information" },
