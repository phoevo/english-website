export const vocab: Record<string, { text: string; type: string; definition: string }> = {
  ...
  "fantastic": { text: "fantastic", type: "adjective", definition: "extraordinarily good or attractive." },
    ...
    "as": { text: "as", type: "conjunction", definition: "used to indicate a reason or comparison." },
"because": { text: "because", type: "conjunction", definition: "used to give a reason." },
"so": { text: "so", type: "conjunction", definition: "used to show a result or effect." },
"when": { text: "when", type: "adverb", definition: "at what time or during what time." },
"then": { text: "then", type: "adverb", definition: "at that time or after that." },
"if": { text: "if", type: "conjunction", definition: "used to talk about a condition." },
"too": { text: "too", type: "adverb", definition: "also; in addition." },
...
"their": { text: "their", type: "pronoun", definition: "belonging to them." },
"them": { text: "them", type: "pronoun", definition: "used to refer to people or things that have already been mentioned." },
"who": { text: "who", type: "pronoun", definition: "used to ask or talk about which person." },
"what": { text: "what", type: "pronoun", definition: "used to ask for information." },
"where": { text: "where", type: "adverb", definition: "used to ask or talk about place." },
"why": { text: "why", type: "adverb", definition: "used to ask about reasons or causes." },
"always": { text: "always", type: "adverb", definition: "at all times; on every occasion." },
"never": { text: "never", type: "adverb", definition: "not ever; at no time." },
"every": { text: "every", type: "adjective", definition: "including all the individual members of a group." },
"each": { text: "each", type: "pronoun", definition: "refers to every one of two or more people or things considered separately." }
